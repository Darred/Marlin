...
M190 S[bed0_temperature] ; Прогрев стола без ожидания
...
M117 Z steppers auto align

G34 T0.01 I8 ; Z Steppers Auto-Alignment
...
G1 Z5 E-2 F200 ; поднять сопло 5 мм и втянуть филамент(ретракт) на 2мм

M117 Start

G92 E0 ;обнулить значение пути экструдера
G1 F200 E3 ;подать в экструдер 5мм филамента.
*/
/**
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 96.8, 100.5, 800, 782.387 }
